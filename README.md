...
- Create subscription products for each plan tier
- Create subscription products for recurring add-ons
- Create one-time products for credit packs / permanent purchases
- Create meters for metered resources
- Configure webhooks to `https://billing.apollodeploy.com/webhooks/polar`
