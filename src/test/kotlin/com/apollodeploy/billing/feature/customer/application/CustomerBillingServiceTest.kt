...
class CustomerBillingServiceTest {
    ...
    @Test
    fun `4_1 updateBillingInfo with empty orgId returns InvalidRequest without calling repo`() = runBlocking {
    ...
    @Test
    fun `4_2 updateBillingInfo with whitespace-only orgId returns InvalidRequest without calling repo`() = runBlocking {
        val result = service.updateBillingInfo(UpdateCustomerBillingInfoRequest(orgId = "   ", email = "x@x.com"))
    ...
    @Test
    fun `4_3 updateBillingInfo with valid orgId and all optional fields null returns InvalidRequest`() = runBlocking {
    ...
    @Test
    fun `4_4 updateBillingInfo with valid orgId and non-null email calls repo and returns Success`() = runBlocking {
        coEvery {
    ...
    @Test
    fun `4_5 listPaymentMethods with null orgId returns InvalidRequest without calling repo`() = runBlocking {
    ...
    @Test
    fun `4_6 listPaymentMethods with blank orgId returns InvalidRequest without calling repo`() = runBlocking {
    ...
    @Test
    fun `4_7 deletePaymentMethod with null orgId returns InvalidRequest without calling repo`() = runBlocking {
    ...
    @Test
    fun `4_8 deletePaymentMethod with non-blank orgId and blank paymentMethodId returns InvalidRequest`() = runBlocking {
    ...
    @Test
    fun `4_9 deletePaymentMethod with blank orgId returns InvalidRequest`() = runBlocking {
    ...
    @Test
    fun `4_10 updateBillingInfo with null-valued PolarCallResult returns PolarFailure without NPE`() = runBlocking {
        coEvery {
            repo.updateCustomerBillingInfo(any(), any(), any(), any(), any(), any())
